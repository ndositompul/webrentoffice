    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                //penggunaan schema jika ingin menambahkan >1 photo
                //menggunakan components (Repeater::make)
                ...
                //penggunaan schema jika ingin menambahkan point pada text
                //menggunakan function (Repeater::make)
                Forms\Components\Repeater::make('benefits')
                ->relationship('benefits') //relationship digunakan untuk menyimpan data ke table lainnya(foreignkey)
                ->schema([
                    Forms\Components\TextInput::make('name')
                    ->required(),
                ]),
                ...
                ->relationship('city', 'name') //relationship ini adalah untuk menampilkan beberapa data yang ada di tabel city
                ->searchable()
                ->preload()
                ->required(),
